...
const WeekendNotifications = () => {
  ...
  const isWeekend = eventTime.isBetween(startOfSaturday, endOfSunday, null, "[]");

  console.log(
    `Checking event ${event.title}: ${eventTime.format()} - Is Weekend?`,
    isWeekend
  );
  ...
  return isWeekend;
    ...
    console.log("Event Times:", events.map(e => dayjs.utc(e.start_time).format()));
