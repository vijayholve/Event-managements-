...
const thisFridayEvening = now.day(5).hour(18).minute(0).second(0); // Friday 6 PM IST
const thisSunday = now.day(7).endOf("day"); // Sunday 11:59:59 PM IST

// Filter using the updated range
const isWeekend = eventTime.isBetween(thisFridayEvening, thisSunday, null, "[]");
